...
public class PoolConnection {
	...
	private Connection connect() {
		try {
			...
			String dbConnectString = jdbc + servidor + "/APIDB?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
