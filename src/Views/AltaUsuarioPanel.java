	...
	public AltaUsuarioPanel() {
		...
		btnCrear.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				LocalDate fechaNacimiento = LocalDate.of(Integer.parseInt(textAnio.getText()),
						Integer.parseInt(textMes.getText()), Integer.parseInt(textDia.getText()));
				Usuario nuevoUsuario = new Usuario(id, nombre, email, password, nombreUsuario, domicilio, dni,
						fechaNacimiento);
